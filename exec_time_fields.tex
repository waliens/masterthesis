...
\begin{table}
	...
	\begin{tabular}{|c|c|c|c|c|c|c|c|}
	\hline
	 \parbox[t]{2mm}{\multirow{9}{*}{\rotatebox[origin=c]{90}{Run information}}} & Run nb. & 7 & 8 & 10 \\
...
\begin{table}
	...
	\hline
	 \parbox[t]{2mm}{\multirow{9}{*}{\rotatebox[origin=c]{90}{Run information}}} & Run nb. & \multicolumn{2}{c|}{11} & \multicolumn{2}{|c|}{12} \\
