...
\begin{figure}
	...
	\subfigure [Overlapping] {
		\includegraphics[scale=0.38]{image/failure_reseg_overlap_1_pat.png}	
		\includegraphics[scale=0.38]{image/failure_reseg_overlap_1_nopat.png}	
	}
	\subfigure [Overlapping] {
		\includegraphics[scale=0.37]{image/failure_reseg_overlap_2_pat.png}	
		\includegraphics[scale=0.37]{image/failure_reseg_overlap_2_nopat.png}	
	}
	\subfigure [Other image] {
		\includegraphics[scale=0.5]{image/failure_reseg_noreason_1_pat.png}	
		\includegraphics[scale=0.55]{image/failure_reseg_noreason_1_nopat.png}
	}
	\caption{}
